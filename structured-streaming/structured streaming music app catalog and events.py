...
test_musicapp_events_raw = musicapp_events_raw()
display(test_musicapp_events_raw)
...
def musicapp_events_parsed_bronze():
  return (
#     dlt.read_stream("musicapp_events_raw")  
    test_musicapp_events_raw  
...
test_musicapp_events_parsed_bronze = musicapp_events_parsed_bronze()
display(test_musicapp_events_parsed_bronze)

# COMMAND ----------

# MAGIC %md
# MAGIC ### Create Windowed Table

# COMMAND ----------

# Group the data by window and word and compute the count of each group
windowedCounts = test_musicapp_events_parsed_bronze.groupBy(
    window(test_musicapp_events_parsed_bronze.timestamp, "10 minutes", "5 minutes"),
    test_musicapp_events_parsed_bronze.artist
).count()
